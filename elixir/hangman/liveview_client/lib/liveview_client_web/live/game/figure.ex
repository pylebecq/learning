defmodule LiveviewClientWeb.Live.Game.Figure do
        ...
        <div class="h-[400px] grow-0">
          <svg id="drawing"
            ...
            <g transform="translate(-27.2 -220)">
              <!-- 1 -->
              <path id="rope"
                    class={hide_if_turns_left_gt(@turns_left, 6)}
              ...
              <!-- 6 -->
              <path id="arm1"
                    class={hide_if_turns_left_gt(@turns_left, 0)}
              ...
              <!-- 7 -->
              <path id="arm2"
                    class={hide_if_turns_left_gt(@turns_left, 1)}
                    style="fill: #777; stroke: #777; stroke-width: 3.5;"
              ...
              <!-- 8 -->
              <path id="leg1"
                    class={hide_if_turns_left_gt(@turns_left, 2)}
                    style="fill: #777; stroke: #777; stroke-width: 3.5;"
              ...
              <!-- 9 -->
              <path id="leg2"
                    class={hide_if_turns_left_gt(@turns_left, 3)}
                    style="fill: #777; stroke: #777; stroke-width: 3.5;"
              ...
              <!-- 10 -->
              <path id="body"
                    class={hide_if_turns_left_gt(@turns_left, 4)}
                    style="fill: #777; stroke: #777; stroke-width: 3.5;"
              ...
              <!-- 11 -->
              <path id="head"
                    class={hide_if_turns_left_gt(@turns_left, 5)}
  ...
  defp hide_if_turns_left_gt(turns_left, level) do
    if turns_left > level, do: "opacity-10", else: ""
  end
end
